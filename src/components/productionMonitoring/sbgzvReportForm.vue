            ...
            <div class="container">
                <div class="handle-box">
                    <label style="margin-right: 10px">
                        <span>智能检索设备</span>
                        <span>:</span>
                        <el-input v-model="select_word" placeholder="智能检索设备" class="handle-input mr10" style="width: 150px"></el-input>
                    </label>
    ...
    export default {
        ...
        methods: {
            ...
            importPrinting(){
                ...
                try {
                    FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '设备故障率报表.xlsx');
                } catch (e)
                {
