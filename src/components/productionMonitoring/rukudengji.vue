        ...
        <div class="template-content">
            <div class="container">
                <div class="handle-box">
                    ...
                    <el-button type="success" icon="delete" class="handle-del mr10" @click="showCkjv">入库记录</el-button>
                </div>
                <div class="">
            ...
            <!-- 入库记录 -->
            <el-dialog title="入库记录修改" :visible.sync="editVisible" width="80%">
                <el-form ref="form" label-width="100px">
                    <el-form-item label="分类">
                        <el-select
                            v-model="fenlei"
            ...
            <!-- 入库记录列表 -->
            <el-dialog title="入库记录修改" :visible.sync="ckjvVisible" width="80%">
