    ...
    <div class="template">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>船号管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="template-content">
            <div class="container">
                <div class="handle-box">
                    ...
                    <el-button type="primary" icon="delete" class="handle-del mr10" @click="addContent">新增船号</el-button>
                    <el-button type="danger" icon="delete" class="handle-del mr10" @click="deleteContent">删除船号
                    </el-button>
                </div>
                <div class="">
            ...
            <!--新增弹出框 -->
            <el-dialog title="新增船号" :visible.sync="addVisible" width="60%">
            ...
            <!-- 编辑弹出框 -->
            <el-dialog title="编辑船号" :visible.sync="editVisible" width="60%">
                <el-form ref="form" label-width="100px">
                    <el-form-item label="所属船型">
                        <el-select
                            v-model="shipType"
            ...
            <!-- 删除提示框 -->
            <el-dialog title="删除船号" :visible.sync="delVisible" width="300px" center>
