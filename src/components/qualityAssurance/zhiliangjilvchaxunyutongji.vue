    ...
    <div class="editorTemplate">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>质量记录查询与统计</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <div class="container">
                <div class="handle-box">
                    <label style="margin-right: 5px">
                        <el-input v-model="select_word" placeholder="筛选质量记录" class="handle-input mr10" style="width: 150px"></el-input>
                    </label>
    ...
    export default {
        ...
        data() {
            return {
                ...
                xuexi:"",
                xuexiOptions:[{"name": "自检记录", "id": "1"}, {"name": "管理记录", "id": "2"},],
        ...
        methods: {
            ...
            loadingShowData(data){
                let that = this;
                axios.all([
                    axios.post(" " + url + "/sys/showTableTitle", {"name": "zhiliangjilvchaxunyutongji"}),
