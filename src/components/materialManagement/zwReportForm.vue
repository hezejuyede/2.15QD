            ...
            <div class="container">
                <div class="handle-box">
                    <label style="margin-right: 5px">
                        <span>智能检索注文金物</span>
                        <span>:</span>
                        <el-input v-model="select_word" placeholder="智能检索注文金物" style="width: 200px" class="handle-input mr10"></el-input>
                    </label>
    ...
    export default {
        ...
        methods: {
            ...
            importPrinting(){
                ...
                try {
                    FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '注文金物报表.xlsx');
                } catch (e)
                {
