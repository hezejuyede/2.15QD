    ...
    <div class="template">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>托单查询与打印</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <div class="container">
                ...
                <div class="">
                    <el-table class="tb-edit"
                              :data="tables"
                              :header-cell-style="{background:'#A1D0FC',color:'rgba(0, 0, 0, 0.8)',fontSize:'13px'}"
                              border
            ...
            <el-dialog title="托单金物制作" :visible.sync="editVisible" width="100%" :fullscreen="true" :center="true">
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="saveEdit"
                               style="height:30px;width:100px">打 印</el-button>
            </span>
            </el-dialog>
    ...
    export default {
        ...
        methods: {
            ...
            loadingShowData(data1, data2, data3, data4) {
                let that = this;
                axios.all([
                    axios.post(" " + url + "/sys/showTableTitle", {"name": "tuodanchaxunyudayin"}),
                    axios.post(" " + url + "/wuliao/tuodanjinwuList", {
                        "times": data1,
                        "chuanhao": data2,
                        "quhuaming": data3,
                        "tuhao": data4,
            ...
            showModel() {
                if (this.listData.length) {
                    if (this.listData.length === 1) {
                        ...
                        axios.post(" " + url + "/wuliao/tuodanchuku/tuodanjinwuDetail", {"id": this.listData[0]})
                            .then((res) => {
