        ...
        <div class="editorTemplate-content">
            <div class="container">
                <div class="handle-box">
                    ...
                    <el-button type="primary"  @click="doSearch">查询确认</el-button>
                    <el-button type="success"  @click="showAdd">新增确认</el-button>
                    <el-button type="warning"  @click="showEdit">编辑确认</el-button>
                    <el-button type="danger"   @click="deleteAlert">删除确认</el-button>
                </div>
                <div class="">
