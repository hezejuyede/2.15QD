    ...
    <div class="template">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>资质设定</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="template-content">
            <div class="container">
                <div class="handle-box">
                    <label style="margin-right: 10px">
                        <span>智能检索资质</span>
                        <span>:</span>
                        <el-input v-model="select_word" placeholder="智能检索资质" class="handle-input mr10"></el-input>
                    </label>
                    <el-button type="primary" icon="delete" class="handle-del mr10" @click="showAdd">新增资质</el-button>
                    <el-button type="danger" icon="delete" class="handle-del mr10" @click="showDelete">删除资质</el-button>
                </div>
                <div class="">
            ...
            <!-- 编辑弹出框 -->
            <el-dialog title="编辑资质" :visible.sync="editVisible" width="40%">
                <el-form ref="form"  label-width="100px">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            doAdd() {
                if (this.name ) {
                    axios.post(" " + url + "/sysconfig/zizhiAdd",
                        {
                            "name": this.name
                        }
                    )
            ...
            edit(row, column, cell, event) {
                ...
                this.id = row.id;
                axios.post(" " + url + "/sysconfig/zizhiDetail", {"id": this.id})
                    .then((res) => {
            ...
            saveEdit() {
                if (this.name) {
                    axios.post(" " + url + "/sysconfig/updateZizhi",
                        {
                            "id": this.id,
                            "name": this.name,
                        }
            ...
            // 确定删除
            deleteRow() {
                axios.post(" " + url + "/sysconfig/delZizhi",
                    {
                        "ids": this.listData,
                    }
                )
